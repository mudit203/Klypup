...
import { Mail, Lock, Eye, EyeOff, Building2, User, TrendingUp, Play, ShieldAlert, ArrowRight } from 'lucide-react';
      ...
      <div className="lg:col-span-7 xl:col-span-7 flex flex-col justify-center px-6 py-12 md:px-12 lg:px-16 xl:px-24">
        <div className="mx-auto w-full max-w-sm space-y-8">
          ...
          <div className="space-y-2">
            <h2 className="text-2xl font-bold tracking-tight text-neutral-950">Create account</h2>
            <p className="text-sm text-neutral-500">
              Establish a new pricing simulation environment today.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4.5">
            ...
            <div className="space-y-1.5">
              <label htmlFor="orgName" className="text-xs font-bold text-neutral-700 uppercase tracking-wider">
                Organization Name
              </label>
              <div className="relative rounded-xl shadow-sm">
                ...
                <input
                  ...
                  className={`block w-full rounded-xl border ${
                    validationErrors.orgName ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : 'border-neutral-200 focus:ring-neutral-950 focus:border-neutral-950'
              ...
              {validationErrors.orgName && (
                <p className="text-xs font-medium text-red-600 pl-1">{validationErrors.orgName}</p>
              )}
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative rounded-xl shadow-sm">
                ...
                <input
                  ...
                  disabled={isLoading}
                  className={`block w-full rounded-xl border ${
                    validationErrors.name ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : 'border-neutral-200 focus:ring-neutral-950 focus:border-neutral-950'
                  } bg-neutral-50/50 py-3 pl-10 pr-4 text-neutral-900 placeholder-neutral-400 focus:bg-white focus:ring-1 sm:text-sm transition-all outline-none`}
              ...
              {validationErrors.name && (
                <p className="text-xs font-medium text-red-600 pl-1">{validationErrors.name}</p>
              )}
            </div>
          ...
          <p className="text-center text-sm text-neutral-500">
            ...
            <a href="/login" className="font-bold text-neutral-950 hover:underline underline-offset-4 transition-colors">
              Log In
            </a>
          </p>
        </div>
